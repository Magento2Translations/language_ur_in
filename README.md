...
# Version & progress
This translation is generated from the branch [2.1.16](https://crowdin.com/project/magento-2/ur-in#/2.1.16) at Crowdin and based on the Magento 2.1.16 sourcefiles.
There have been  0 strings translated of the 8620 strings in the Magento source.
...
If they have a similar language pack to this one you can find it [here](https://github.com/magento-l10n/language-ur_IN).
...
composer require magento2translations/language_ur_in:2.1.16-dev
php bin/magento cache:clean
```
## Manually
To install this language package manually you need access to your server file system.
* Download the zip file [here](https://github.com/Magento2Translations/language_ur_in/archive/2.1.16.zip).
